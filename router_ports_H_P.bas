...
' ------------------------------
    ...
    For i = 2 To FinalRow
        ...
        ' If (s4Status <> "Rezerviran") And (s14noVLAN = "") And ((s6Description = "--") Or (s6Description = "")) And ((s9Path = "--") Or (s9Path = "")) Then
        If (s4Status = "Isključen") And ((s6Description = "--") Or (s6Description = "")) And ((s9Path = "--") Or (s9Path = "")) Then
        ...
        ElseIf (s4Status = "Isključen") And ((s6Description = "--") Or (s6Description = "")) And ((s9Path <> "--") Or (s9Path <> "")) Then
            ...
            With Selection.Interior
                ...
                .PatternTintAndShade = 0
            End With
        ' ElseIf (s4Status = "Aktivan") And (s14noVLAN <> "") And ((s12User = "-") Or (s12User = "")) Then
